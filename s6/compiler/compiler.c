...
int getAddress(tnode *node) {
    if (node->t == argument)
        ...
        return node->u.variable->binding;
}
    ...
    if (tree) {
        ...
        case OP:
            ...
            case READ:
                ...
                fprintf(fp, "PUSH R%d\n", reg1);                            // Arg 1
                fprintf(fp, "MOV R%d, BP\n", reg1);                         // BP
                fprintf(fp, "ADD R%d, %d\n", reg1, getAddress(tree->left)); // Move BP + address
            ...
            case RETURN:
                ...
                fprintf(fp, "MOV [R%d], R%d\n", reg2, reg1);
                freeReg(reg1);
                for (int i = 0; i < (stail ? stail->sno : 0); i++) {
                    fprintf(fp, "POP R%d\n", reg2);
                }
                fprintf(fp, "POP BP\n");
                fprintf(fp, "RET\n");
            ...
            case FUN:
                ...
                fprintf(fp, "POP R%d\n", reg2); // Retrive return value
                if (count)
                    fprintf(fp, "POP R%d\n", pushReg[0]); // Poping off argument
                else
                    fprintf(fp, "POP R0\n");
